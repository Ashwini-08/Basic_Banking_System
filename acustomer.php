...
<body style="background-color:#F4F6F7;" onload="loader()">
...
<div class="container-fluid myclass" style="padding:0px; margin:0px;">
        ...
        <nav class="navbar navbar-expand-sm  navbar-toggler navbar-light" style="background-color:transparent; background-color:#B8F2F5; opacity:1;">  
            ...
            &nbsp;
            <div class="navbar-brand font-weight-bold " id="title" data-anijs="if: mouseover, do: slideInUp animated" style="color:black;font-family: 'Courgette', cursive;font-weight: normal;font-size:2em;">
                &nbsp;Banking System
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02" style="float:right;">
                ...
                <li class="nav-item">
                        <a class="nav-link " href="index.php" style="color:black;font-weight:1em;font-size: 20px;">
                            ...
                            <span style="padding-right:20px;font-family: 'Courgette', cursive;" >&nbsp;&nbsp;Home</span>
                        </a> 
                    </li> 
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="transferrecords.php" style="color:black;font-weight:1em;font-family: 'Courgette', cursive;font-size: 20px;">
                            <div style="padding-left:20px;" >
...
<div class="row">
    ...
    <div style="padding-top:2%;display:inline;"><h4 class="font-weight-bold" style="color:#051179;font-size:2em;;display:inline;margin:10px 5px 0px 5px;padding-top:1%">Customer Details</h4>
    </div>
        <br><br>
    ...
    <div class="col-sm" style="padding:1% 3%;">
        <div >
                    ...
                    <span class="font-weight-bold" style="color:#051179;font-size:1.8em;line-height:1em;display:inline;margin:10px 5px 0px 5px;padding-top:1%">Money Transfer</span>
                    </div><br><br>
                ...
                <select style="background-color: #D6DBDF;border-color: #D6DBDF;"name="reciever" id="dropdown" required>
                ...
                <br><br><br>
                        ...
                        <input name="amount" type="number" style="width:35%;background-color: #D6DBDF;border-color: #D6DBDF; min="100" required >
                        <br><br><br>
