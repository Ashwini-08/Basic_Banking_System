            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02" style="float:right;">
                ...
                <li class="nav-item">
                        <a class="nav-link " href="index.php" style="color:black;font-weight:1em;font-size: 20px;">
                            ...
                            <span style="padding-right:30px;font-family: 'Courgette', cursive;font-size: 20px;" >&nbsp;&nbsp;Home</span>
                        </a> 
                    </li> 
                    <li class="nav-item">
...
<div class="usertable">
    ...
    <h3 class="font-weight-bold"style="text-align:center;color:black;font-family: 'Courgette', cursive;font-size:2.2em;padding:3%;letter-spacing: 2px;">Customers</h3>
    <table id="myTable" style="border: 3px solid black;">
        ...
        while($row = mysqli_fetch_assoc($result)){
            ...
            echo "<td style='background-color: #f2e1ec;border-color: black;'>". $row['customer_id'] . "</td>
            <td style='background-color: #f2e1ec;border-color: black;'>". $row['name'] . "</td>
            <td style='background-color: #f2e1ec;border-color: black;'>". $row['email'] . "</td>
            <td style='background-color: #f2e1ec;border-color: black;'>". $row['current_balance'] . "</td>";
           echo "<td style='background-color: #f2e1ec;border-color: black;'> <a href='acustomer.php'><button type='submit'style='background-color:#040945  ; border-color:#040945  ;' class='btn btn-default' name='user'  id='users1' value= '{$row['name']}' >View Customer</button></a></td>";
            echo "</form>";
           echo  "</tr>";
        }
        ?>
